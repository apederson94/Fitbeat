class StringConstants {
  ...
  static String userIdSC = "user_id";
  static String scope = "scope";
  static String tokenTypeSC = "token_type";
  static String expiresInSC = "expires_in";
  static String refreshData = "Refresh Data";
  static String connectToFitbit = "Connect to Fitbit";
  static String fitbitAuthEndpoint = "https://www.fitbit.com/oauth2/authorize?response_type=token&client_id=22BBXX&redirect_uri=fitbeat%3A%2F%2Fauth&scope=activity";
